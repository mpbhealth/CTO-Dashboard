          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4">
            <div>
              ...
              <select
                ...
                className="w-full md:w-64 px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-indigo-500"
              >
            ...
            <div>
              ...
              <select
                ...
                className="w-full md:w-48 px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-indigo-500"
              >
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              ...
                              <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                                ...
                                feedbackItem.feedback_type === 'suggestion' ? 'bg-indigo-100 text-indigo-800' :
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
                    <div className="flex items-center justify-between mb-1">
                      <h3 className="font-medium text-indigo-800">Total KPIs</h3>
                      <BarChart className="w-5 h-5 text-indigo-600" />
                    </div>
                    <p className="text-2xl font-bold text-indigo-900">
                      {employeeKpis.length}
                    </p>
                    <p className="text-sm text-indigo-700">Active KPI measurements</p>
                  </div>
                </div>
            ...
            {employeeFeedback.length > 0 ? (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                  ...
                  <div className="p-4 bg-slate-50 rounded-lg border border-slate-200">
                    <div className="text-indigo-600 mb-1">Suggestions</div>
                    <div className="text-2xl font-bold text-slate-900">
                        ...
                        <div>
                          <div className="flex items-center space-x-2">
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                              ...
                              feedback.feedback_type === 'suggestion' ? 'bg-indigo-100 text-indigo-800' :
                              'bg-slate-100 text-slate-800'
                            }`}>
                            ...
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                              feedback.visibility === 'public' ? 'bg-indigo-100 text-indigo-800' :
                          ...
                          <div className="w-full bg-slate-200 rounded-full h-2">
                            <div 
                              className={`h-2 rounded-full ${
                                ...
                                goal.progress > 25 ? 'bg-indigo-500' : 
                                'bg-amber-500'
                              }`}
