...
export default function Sidebar({
  ...
  return (
    ...
    >
     ...
     <button
       className={`absolute top-4 -right-12 p-2 rounded-full ${isCEO ? 'bg-pink-600' : 'bg-sky-600'} text-white md:hidden z-50 cursor-pointer`}
                   ...
                   <li key={item.id} className={`${!isSidebarExpanded ? 'flex justify-center' : ''} sidebar-menu-item`} style={{pointerEvents: 'auto', zIndex: 53, position: 'relative'}}>
                      <button
                       ...
                       className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-all duration-200 group text-left w-full cursor-pointer sidebar-btn ${
                          isActive && !hasSubmenu
                            ? isCEO ? 'bg-pink-900 font-semibold shadow-lg text-white' : 'bg-sky-600 font-semibold shadow-lg shadow-sky-500/25 text-white'
                              ...
                              <li key={subItem.id}>
                                <button
                                  ...
                                  className={`flex items-center px-3 py-2 rounded-lg text-sm transition-all duration-200 w-full text-left ${
                                    isSubActive
                                      ? isCEO ? 'bg-pink-900 font-semibold text-white' : 'bg-sky-600 font-semibold text-white'
