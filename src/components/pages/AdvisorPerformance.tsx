          ...
          <div className="flex items-center justify-between mb-6">
            ...
            {topAdvisors.length > 0 && (
              <select
                ...
                className="px-3 py-1 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-indigo-500"
              >
                {topAdvisors.map(advisor => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        >
          ...
          <div className="space-y-4">
            {[
              { stage: 'Calls Made', value: 174, icon: Phone, color: 'bg-indigo-500' },
