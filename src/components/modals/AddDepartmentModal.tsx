        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[calc(90vh-140px)] space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-6 border-t border-slate-200">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex items-center gap-2 px-4 py-2 bg-sky-600 text-white rounded-lg hover:bg-sky-700 disabled:opacity-70 disabled:cursor-not-allowed transition-colors"
            >
