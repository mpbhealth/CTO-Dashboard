...
export function CEOBoardPacket() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'In Review': return 'bg-pink-100 text-pink-500';
    ...
    <div className="w-full space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 min-h-[44px] bg-gradient-to-r from-pink-400 to-pink-500 text-white rounded-lg hover:opacity-90 transition-opacity font-medium shadow-md"
          >
            <Plus size={18} />
            New Packet
          </button>
              ...
              <div key={packet.id} className="bg-white rounded-xl shadow-sm border p-4 sm:p-6 hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    className="flex items-center gap-1 px-4 py-2 min-h-[44px] bg-gradient-to-r from-pink-400 to-pink-500 text-white rounded-lg hover:opacity-90 transition-opacity text-sm font-medium shadow-md"
                  >
                    <Edit size={16} />
                    Edit
                  </button>
            ...
            {templates.map((template) => {
              ...
              return (
                <div key={template.name} className="bg-white rounded-xl shadow-sm border p-4 sm:p-6 hover:shadow-md transition-shadow cursor-pointer">
                  <Icon size={32} className="text-pink-500 mb-3" />
                  <h3 className="font-semibold text-gray-900 mb-2">{template.name}</h3>
                  <p className="text-sm text-gray-500">{template.sections.length} sections included</p>
                  <button
                    onClick={() => handleUseTemplate(template.name)}
                    className="mt-4 w-full px-4 py-2 bg-gradient-to-r from-pink-400 to-pink-500 text-white rounded-lg hover:opacity-90 transition-opacity text-sm font-medium shadow-md"
                  >
                    Use Template
                  </button>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-gradient-to-r from-pink-400 to-pink-500 text-white rounded-lg hover:opacity-90 transition-opacity font-medium shadow-md"
                >
                  Create Packet
                </button>
              </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-pink-400 to-pink-500 text-white rounded-lg hover:opacity-90 transition-opacity font-medium shadow-md"
                        >
                          <Save size={18} />
                          Save Changes
                        </button>
