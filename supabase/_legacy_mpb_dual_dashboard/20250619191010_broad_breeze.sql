/*
  ...
  1. Clear existing roadmap data
  2. Insert comprehensive roadmap items that align with current projects
  3. Ensure all projects are represented in the roadmap
  4. Add strategic initiatives for future quarters

  This migration ensures that all active projects are properly represented
  in the technology roadmap with appropriate quarters and dependencies.
*/

-- Clear existing roadmap data
DELETE FROM roadmap_items;

-- Insert comprehensive roadmap items that include all current projects
